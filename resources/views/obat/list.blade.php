<x-layout title="Daftar Obat">
    <div class="p-10 h-full">
        <h1 class="text-xl font-semibold mb-5 text-gray-900 sm:text-2xl dark:text-white">Daftar Obat</h1>
        @if(auth()->user()->isAdmin())
        <div class="mb-4 flex justify-between">
            <a href="{{ route('obat.create') }}" class="text-white bg-primary hover:bg-primary-hover focus:ring-4
                ...
                @foreach($data as $key => $item)
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-3 py-2 flex space-x-2">
                            <a href="{{route('obat.edit', $item->id)}}" class="font-medium text-blue-600
