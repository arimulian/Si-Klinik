<x-layout title="Tambah Daftar Pasien">
<div class="p-10">
    ...
    <div class="bg-gray-200 px-3 py-5 max-w-md mx-auto rounded-lg">
        <form action="{{route('pasien.store')}}" method="post" class="max-w-sm mx-auto">
            @csrf
            <div class="mb-2">
            ...
            <div class="flex items-start mb-5 space-x-3">
                ...
                <a href="{{route('pasien.list')}}" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4
                focus:outline-none
