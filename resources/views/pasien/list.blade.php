<x-layout title="Daftar Pasien✨">
    <div class="p-10 h-full">
        <h1 class="text-xl mb-5 font-semibold text-gray-900 sm:text-2xl dark:text-white">Daftar Pasien</h1>
        @if(auth()->user()->isAdmin())
        <div class="mb-4 flex justify-between">
            <a href="{{ route('pasien.create') }}" class="text-white bg-primary hover:bg-primary-hover focus:ring-4
